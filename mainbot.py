...
while True:
    user = api.get_user('p_narasannavar')
    api.update_profile(name=f'Pooja_Narasannavar|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Pooja_Narasannavar|{follower_count(user)} Followers')
